...
# *****TODO: set args in utils.py, especially split_id*****
os.chdir("..")
...
include_num = True
print("include_num: %s" % (include_num))
...
def train(model):
    ...
    for i in range(num_round):
        ...
        if batch_size > 0:
            ...
            gen = handset_model.OverSamplingBatchGenerator(data_train_dict, batch_size=batch_size, r=ratio)
...
history_pred_path = "history/%s_%d_%d_%d_history_pred.pickle" % (algo, ratio, int(include_num), args.data_split_id)
